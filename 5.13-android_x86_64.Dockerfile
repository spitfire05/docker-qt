# Docker container to build Qt 5.12 for Android x86 projects with OpenSSL
# Image: a12e/docker-qt:5.12-android_x86
...
ENV \
    ...
    ANDROID_NDK_TOOLCHAIN=${ANDROID_NDK_ROOT}/toolchains/x86-${ANDROID_NDK_TOOLCHAIN_VERSION}/prebuilt/${ANDROID_NDK_HOST}
