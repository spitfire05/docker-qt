# Docker container to build Qt 5.9 for Android armv7 projects with OpenSSL
# Image: a12e/docker-qt:5.9-android_armv7
...
COPY scripts/install-openssl-android-gcc-armv7.sh /tmp/build/
